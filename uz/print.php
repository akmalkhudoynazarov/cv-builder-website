...
<head>
    ...
    <title>Rezyumeni Yuklab Oling</title>
    <style>
    @page{
        padding: 0;
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        // Gender in uzbek language
        $x = $row['Gender'];
        if ($x == "Female") {
            $html .= '<td style="border-left: 1px solid white;text-align:center;padding-left: 4px;padding-right: 4px;">Ayol</td>';
        } elseif ($x == "Male") {
            $html .= '<td style="border-left: 1px solid white;text-align:center;padding-left: 4px;padding-right: 4px;">Erkak</td>';
        } elseif ($x == "Other") {
            $html .= '<td style="border-left: 1px solid white;text-align:center;padding-left: 4px;padding-right: 4px;">Boshqa</td>';
        }
        ...
        $html .= '<div class="empty-container"></div><section>
            <div class="work">
                <table>
                    <tr>
                        <th colspan="2">
                            <h2 style="letter-spacing: 1.5px">Ish Tajribasi</h2>
                            <hr>
                        </th>
                    </tr>';
        while ($row = $result->fetch_assoc()) {
            ...
            if (empty($row['Employment_Ongoing'])) {
                ...
                $html .= '<h3>' . $row['Employment_From'] . ' <span>/</span> Hozirgacha</h3>';
            }
    ...
    $html .= '<section>
            <div class="work">
                <table>
                    <tr>
                        <th colspan="2">
                            <h2 style="letter-spacing: 1.5px">Ta\'lim</h2>
                            <hr>
                        </th>
                    </tr>';
    while ($row = $result->fetch_assoc()) {
        ...
        if ($y == "Secondary School") {
            $html .= '<h4 class="degree">O\'rta ta\'lim</h4>';
        } elseif ($y == "High School") {
            $html .= '<h4 class="degree">O\'rta-maxsus</h4>';
        } elseif ($y == "Bachelor Degree") {
            $html .= '<h4 class="degree">Bakalavr</h4>';
        } elseif ($y == "Master Degree") {
            $html .= '<h4 class="degree">Magistr</h4>';
        } elseif ($y == "PhD") {
            $html .= '<h4 class="degree">PhD</h4>';
        } elseif ($y == "Diploma") {
            $html .= '<h4 class="degree">Diplom</h4>';
        } elseif ($y == "Certificate") {
            $html .= '<h4 class="degree">Sertifikat</h4>';
        }
        ...
        if (empty($row['School_Ongoing'])) {
            ...
            $html .= '<h3>' . $row['School_From'] . ' <span>/</span> Hozirgacha</h3>';
        }
...
if ($result->num_rows > 0) {
    if (!empty($check['Language'])) {
        $html .= '<section>
            <div class="work">
                            <h2 style="letter-spacing: 1.5px">Tillar</h2>
                            <hr>
                            <div class="language">
                            <ul>';
        while ($row = $result->fetch_assoc()) {
            ...
            if ($row['Language_Level'] == "Basic") {
                $html .= "<h4 style='letter-spacing: 1.3px'>" . $row['Language'] . "<span style='font-weight: normal;'> - Boshlang'ich</span></h4>";
            } elseif ($row['Language_Level'] == "Good") {
                $html .= "<h4 style='letter-spacing: 1.3px'>" . $row['Language'] . "<span style='font-weight: normal;'> - Yaxshi</span></h4>";
            } elseif ($row['Language_Level'] == "Expert") {
                $html .= "<h4 style='letter-spacing: 1.3px'>" . $row['Language'] . "<span style='font-weight: normal;'> - Ekspert</span></h4>";
            }
            $html .= '</li>';
        }
        $html .= '</ul>
...
if ($result->num_rows > 0) {
    if (!empty($check['Digital'])) {
        $html .= '<section>
            <div class="work">
                            <h2 style="letter-spacing: 1.5px">Raqamli Ko\'nikmalar</h2>
                            <hr>
                            <div class="language">
                            <ul>';
        while ($row = $result->fetch_assoc()) {
            ...
            if ($row['Digital_Level'] == "Basic") {
                $html .= "<h4 style='letter-spacing: 1.3px'>" . $row['Digital'] . "<span style='font-weight: normal;'> - Boshlang'ich</span></h4>";
            } elseif ($row['Digital_Level'] == "Good") {
                $html .= "<h4 style='letter-spacing: 1.3px'>" . $row['Digital'] . "<span style='font-weight: normal;'> - Yaxshi</span></h4>";
            } elseif ($row['Digital_Level'] == "Expert") {
                $html .= "<h4 style='letter-spacing: 1.3px'>" . $row['Digital'] . "<span style='font-weight: normal;'> - Ekspert</span></h4>";
            }
            $html .= '</li>';
        }
        $html .= '</ul>
...
$dompdf->render();
//For view
// $dompdf->stream("Rezyume", array("Attachment" => true));
// for download
$dompdf->stream("rezyume.pdf");
